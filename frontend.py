...
class YOLO(object):
    ...
    def custom_loss(self, y_true, y_pred):
        ...
        anatomical_loss = tf.reduce_sum(anatomical_loss * 20.0) / tf.cast(2 * tf.shape(y_true)[0], dtype=tf.float32) # Hardcoded weight of 20.0 for anatomical loss
...
#                abs_distances = np.vstack((abs_distances, error_abs_distances))
    ...
    def predict(self, image):
        ...
        boxes  = decode_netout(netout, self.anchors, self.nb_class, obj_threshold=0.3, nms_threshold=0.5)
